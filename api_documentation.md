...
Эта инструкция поможет вам установить и запустить платформу обмена товарами, созданную на Django.
...
Если у вас еще нет локальной копии репозитория, выполните команду:
